...
**Earned**
- AWS Cloud Technology and Services Concepts — DataCamp (Jan 2026)
- AWS Security and Cost Management Concepts — DataCamp (Jan 2026)
- AWS Concepts — DataCamp (Jan 2026)
- Understanding Cloud Computing — DataCamp (Jan 2025)
- Software Engineering Principles in Python — DataCamp (Jun 2025)
- Intermediate Python for Developers — DataCamp (May 2026)
- Introduction to Shell — DataCamp (May 2026)
- Intermediate Git — DataCamp (Jan 2025)
- Intermediate GitHub Concepts — DataCamp (Jan 2025)
- Technical Support Fundamentals — Coursera (Mar 2026)
